...
// Internal monitor (dell precision work)
output "PNP(CTO) 0x1115 Unknown" {
    mode "3840x2160"
    position x=0 y=0
    scale 2.25
}
...
output "Dell Inc. DELL P2719HC FT8ZX13" {
...
// External monitor halle robotique table, left screen.
output "Dell Inc. DELL P2719HC 9T8ZX13" {
    // Standard 1080p resolution for this model
    // You can also use "1920x1080@60.000" to be precise
    mode "1920x1080"
...
// Fallback for HDMI-A-1 if another monitor is connected
output "HDMI-A-1" {
   position x=1707 y=0
}
...
// window-rule {
//     match app-id=r#"obs"#
//     open-on-workspace "8-obs"
// }
// window-rule {
//     match app-id=r#"steam"#
//     open-on-workspace "9-oss"
// }
// window-rule {
...
binds {
    ...
    Mod+Shift+TAB repeat=false { spawn "~/.local/bin/nws.sh"; } 
    // Kill focused window
    Mod+Shift+K hotkey-overlay-title="Kill Focused Window" { spawn-sh "~/.local/bin/niri-kill-focused.sh"; }
